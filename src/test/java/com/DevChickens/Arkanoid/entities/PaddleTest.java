...
public class PaddleTest {
    ...
    void setUp() {
        ...
        // Bắt đầu "mock" phương thức static AssetLoader.loadImage()
        ...
        // Tạo mới Paddle
        // Constructor của Paddle sẽ chạy, gọi AssetLoader.loadImage()
        // nhưng chỉ nhận được ảnh giả do chúng ra đã thay thế ở trên.
    ...
    void testConstructorCalculations() {
        // Kích thước mong muốn của Paddle = 1/6 kích thước của GAME_WDITH
        double expectedWidth = GameManager.GAME_WIDTH / 6.0;

        // Tính toán kích thước chiều cao mong muốn của Paddle.
    ...
    void testMoveStopAtRightWall() {
        ...
        paddle.setX(GameManager.GAME_WIDTH - paddleWidth - 1.0); // cách tường một pixel
