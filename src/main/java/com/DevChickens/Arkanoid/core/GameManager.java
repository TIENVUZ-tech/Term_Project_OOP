...
public class GameManager {
    ...
    /**
     * Thêm một quả bóng mới vào danh sách đang chơi.
     * Được gọi bởi MultiBallPowerUp.
     */
    public void addBall(Ball b) {
        if (this.balls != null) {
            // Thêm vào danh sách ở đây
            // Dùng một danh sách tạm để tránh ConcurrentModificationException
            // nếu chúng ta đang ở giữa vòng lặp update
            this.balls.add(b);
        }
    }
    ...
    private void checkCollisions() {
        ...
        for (int i = 0; i < powerUps.size(); i++) {
            ...
            // Khi Paddle va chạm với PowerUp
    ...
    private void resetBallAndPaddle() {
        ...
        balls.clear();
        balls.add(new Ball(GAME_WIDTH / 2.0,
                GAME_HEIGHT - 70,
                3,
                -3,
                5,
